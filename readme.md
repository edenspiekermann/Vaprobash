...
```bash
# curl
$ curl -L https://raw.githubusercontent.com/edenspiekermann/Vaprobash/master/Vagrantfile > Vagrantfile

# wget
$ wget -O Vagrantfile https://raw.githubusercontent.com/edenspiekermann/Vaprobash/master/Vagrantfile
```
